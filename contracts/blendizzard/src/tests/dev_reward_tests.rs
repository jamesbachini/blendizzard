...
fn test_dev_reward_proportional_to_game_fp() {
    ...
    blendizzard.add_game(&game1, &dev1);
    blendizzard.add_game(&game2, &dev2);
    ...
    blendizzard.select_faction(&p4, &1);
    ...
    blendizzard.start_game(&game1, &1, &p1, &p2, &100_0000000, &100_0000000);
    blendizzard.end_game(&1, &true);

    // Game2: Two games with 100 FP wagers each (total 400 FP)
    blendizzard.start_game(&game2, &2, &p3, &p4, &100_0000000, &100_0000000);
    blendizzard.end_game(&2, &true);

    blendizzard.start_game(&game2, &3, &p3, &p4, &100_0000000, &100_0000000);
...
fn test_developer_change_gives_fair_split() {
    ...
    blendizzard.add_game(&game_contract, &original_dev);
...
fn test_total_dev_claims_not_exceed_pool() {
    ...
    blnd_token.mint(&blendizzard.address, &10000_0000000);
    ...
    for i in 0..5 {
        ...
        blendizzard.start_game(&game, &session_id, &p1, &p2, &100_0000000, &100_0000000);
